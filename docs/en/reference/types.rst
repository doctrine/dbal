...
|                   |               | **SQLite**               | *all*   | ``INTEGER`` [16]_                                        |
|                   |               +--------------------------+---------+----------------------------------------------------------+
|                   |               | **Informix**             | *all*   | ``INTEGER`` [12]_ ``SERIAL`` [11]_                       |
+-------------------+---------------+--------------------------+---------+----------------------------------------------------------+
| **bigint**        | ``string``    | **MySQL**                | *all*   | ``BIGINT`` ``UNSIGNED`` [10]_ ``AUTO_INCREMENT`` [11]_   |
|                   | [8]_          +--------------------------+         |                                                          |
|                   |               | **Drizzle**              |         |                                                          |
|                   |               +--------------------------+---------+----------------------------------------------------------+
|                   |               | **PostgreSQL**           | *all*   | ``BIGINT`` [12]_ ``BIGSERIAL`` [11]_                     |
|                   |               +--------------------------+         |                                                          |
|                   |               | **Informix**             |         |                                                          |
|                   |               +--------------------------+---------+----------------------------------------------------------+
...
|                   |               |                          |         | ``NCHAR(n)`` [4]_                                        |
|                   |               +--------------------------+---------+----------------------------------------------------------+
|                   |               | **Informix**             | *all*   | ``CHAR(n)`` [4]_ ``VARCHAR(n)`` [3]_                     |
|                   |               |                          |         | ``LVARCHAR(n)`` [3]_ [21]_                               |
+-------------------+---------------+--------------------------+---------+----------------------------------------------------------+
...
|                   |               +--------------------------+---------+----------------------------------------------------------+
|                   |               | **Informix**             | *all*   | ``DATETIME YEAR TO SECOND``                              |
+-------------------+---------------+--------------------------+---------+----------------------------------------------------------+
...
.. [21] Chosen if the column length is greater than 255.
