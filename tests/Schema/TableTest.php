...
class TableTest extends TestCase
{
    ...
    public function testPartialIndexesWithSameColumnsGetDifferentAutoGeneratedNames(): void
    {
        $table = Table::editor()
            ->setUnquotedName('foo')
            ->setColumns(
        ...
        $table->addIndex(['id'], null, [], ['where' => '(removed_at IS NULL)']);
        $table->addIndex(['id'], null, [], ['where' => '(removed_at IS NOT NULL)']);
