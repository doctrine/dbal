...
, "c" CHAR(36) NOT NULL --(DC2Type:guid)
            ...
            'Column name containing "#" in utf-8 encoding, select column "bar#"' => [
            ...
            'Column name containing "#" default encoding, select column "bar#"' => [
            ...
            'Column name containing "#" in utf-8 encoding, select column "baz"' => [
            ...
            'Column name containing "#" default encoding, select column "baz"' => [
