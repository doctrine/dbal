...
abstract class AbstractPostgreSqlPlatformTestCase extends AbstractPlatformTestCase
{
    ...
    public function testGenerateTableWithAutoincrement()
    {
        ...
        self::assertEquals(array('CREATE TABLE autoinc_table (id SERIAL NOT NULL)'), $this->platform->getCreateTableSQL($table));
    }
    ...
    {
        self::assertSame('BYTEA', $this->platform->getBinaryTypeDeclarationSQL(array()));
        self::assertSame('BYTEA', $this->platform->getBinaryTypeDeclarationSQL(array('length' => 0)));
        self::assertSame('BYTEA', $this->platform->getBinaryTypeDeclarationSQL(array('length' => 9999999)));

        self::assertSame('BYTEA', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true)));
        self::assertSame('BYTEA', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true, 'length' => 0)));
        self::assertSame('BYTEA', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true, 'length' => 9999999)));
    }
    ...
    {
        self::assertSame('UUID', $this->platform->getGuidTypeDeclarationSQL(array()));
    }
