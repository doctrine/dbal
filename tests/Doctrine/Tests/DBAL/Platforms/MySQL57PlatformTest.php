...
class MySQL57PlatformTest extends AbstractMySQLPlatformTestCase
{
    ...
    {
        return array(
            'ALTER TABLE mytable RENAME INDEX `idx-foo` TO `idx-bar`',
        );
    }
    ...
    protected function getQuotedAlterTableRenameIndexInSchemaSQL()
    {
        return array(
            ...
            'ALTER TABLE `schema`.`table` RENAME INDEX `foo` TO `bar`',// Index name with special character in name (needs quotation on some platforms, e.g. Sqlite).
        );
    }
