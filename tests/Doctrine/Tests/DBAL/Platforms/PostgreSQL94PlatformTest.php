...
class PostgreSQL94PlatformTest extends PostgreSQL92PlatformTest
{
    ...
    public function testReturnsJsonTypeDeclarationSQL()
    {
        ...
        self::assertSame('JSON', $this->platform->getJsonTypeDeclarationSQL(array('jsonb' => false)));
        self::assertSame('JSONB', $this->platform->getJsonTypeDeclarationSQL(array('jsonb' => true)));
    }
