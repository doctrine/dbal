...
class SQLAnywherePlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesColumnTypesDeclarationSQL()
    {
        ...
        self::assertEquals('SMALLINT', $this->platform->getSmallIntTypeDeclarationSQL(array()));
        self::assertEquals('UNSIGNED SMALLINT', $this->platform->getSmallIntTypeDeclarationSQL(array(
            'unsigned' => true
        )));
        self::assertEquals('UNSIGNED SMALLINT IDENTITY', $this->platform->getSmallIntTypeDeclarationSQL($fullColumnDef));
        self::assertEquals('INT', $this->platform->getIntegerTypeDeclarationSQL(array()));
        self::assertEquals('UNSIGNED INT', $this->platform->getIntegerTypeDeclarationSQL(array(
            'unsigned' => true
        )));
        self::assertEquals('UNSIGNED INT IDENTITY', $this->platform->getIntegerTypeDeclarationSQL($fullColumnDef));
        self::assertEquals('BIGINT', $this->platform->getBigIntTypeDeclarationSQL(array()));
        self::assertEquals('UNSIGNED BIGINT', $this->platform->getBigIntTypeDeclarationSQL(array(
            'unsigned' => true
        )));
    ...
    public function testCannotGeneratePrimaryKeyDeclarationSQLWithEmptyColumns()
    {
        ...
        $this->platform->getPrimaryKeyDeclarationSQL(new Index('pk', array(), true, true));
    }
    ...
    public function testGeneratesUniqueConstraintDeclarationSQL()
    {
        ...
        self::assertEquals(
            ...
            $this->platform->getUniqueConstraintDeclarationSQL(null, new UniqueConstraint(null, array('a', 'b')))
        );
    }
    ...
    public function testCannotGenerateUniqueConstraintDeclarationSQLWithEmptyColumns()
    {
        ...
        $this->platform->getUniqueConstraintDeclarationSQL('constr', new UniqueConstraint('constr', array()));
    }
    ...
    {
        $this->expectException('\InvalidArgumentException');
        $this->platform->getForeignKeyDeclarationSQL(new ForeignKeyConstraint(array('a', 'b'), 'foreign_tbl', array()));
    }
    ...
    public function testCannotGenerateCommonIndexWithCreateConstraintSQL()
    {
        ...
        $this->platform->getCreateConstraintSQL(new Index('fooindex', array()), new Table('footable'));
    }
    ...
    public function testCannotGenerateCustomConstraintWithCreateConstraintSQL()
    {
        ...
        $this->platform->getCreateConstraintSQL($this->createMock('\Doctrine\DBAL\Schema\Constraint'), 'footable');
    }
    ...
    public function testDoesNotSupportIndexDeclarationInCreateAlterTableStatements()
    {
        ...
        $this->platform->getIndexDeclarationSQL('index', new Index('index', array()));
    }
    ...
    public function testCannotGenerateDropIndexSQLWithInvalidIndexParameter()
    {
        ...
        $this->platform->getDropIndexSQL(array('index'), 'table');
    }
    ...
    public function testGeneratesSQLSnippets()
    {
        ...
        self::assertEquals(
            'LTRIM(column)',
            $this->platform->getTrimExpression('column', AbstractPlatform::TRIM_LEADING)
        );
        self::assertEquals(
            'RTRIM(column)',
        ...
        self::assertEquals(
            'TRIM(column)',
            $this->platform->getTrimExpression('column', AbstractPlatform::TRIM_UNSPECIFIED)
        );
        self::assertEquals(
            "SUBSTR(column, PATINDEX('%[^' + c + ']%', column))",
            $this->platform->getTrimExpression('column', AbstractPlatform::TRIM_LEADING, 'c')
        );
        self::assertEquals(
            "REVERSE(SUBSTR(REVERSE(column), PATINDEX('%[^' + c + ']%', REVERSE(column))))",
            $this->platform->getTrimExpression('column', AbstractPlatform::TRIM_TRAILING, 'c')
        );
        self::assertEquals(
        ...
        self::assertEquals(
            "REVERSE(SUBSTR(REVERSE(SUBSTR(column, PATINDEX('%[^' + c + ']%', column))), PATINDEX('%[^' + c + ']%', " .
            "REVERSE(SUBSTR(column, PATINDEX('%[^' + c + ']%', column))))))",
            $this->platform->getTrimExpression('column', AbstractPlatform::TRIM_UNSPECIFIED, 'c')
        );
    }
    ...
    public function testGeneratesTransactionsCommands()
    {
        self::assertEquals(
            ...
            $this->platform->getSetTransactionIsolationSQL(Connection::TRANSACTION_READ_UNCOMMITTED)
        );
        self::assertEquals(
            'SET TEMPORARY OPTION isolation_level = 1',
            $this->platform->getSetTransactionIsolationSQL(Connection::TRANSACTION_READ_COMMITTED)
        );
        self::assertEquals(
            'SET TEMPORARY OPTION isolation_level = 2',
            $this->platform->getSetTransactionIsolationSQL(Connection::TRANSACTION_REPEATABLE_READ)
        );
        self::assertEquals(
            'SET TEMPORARY OPTION isolation_level = 3',
            $this->platform->getSetTransactionIsolationSQL(Connection::TRANSACTION_SERIALIZABLE)
        );
    }
    ...
    {
        self::assertSame('VARBINARY(1)', $this->platform->getBinaryTypeDeclarationSQL(array()));
        self::assertSame('VARBINARY(1)', $this->platform->getBinaryTypeDeclarationSQL(array('length' => 0)));
        self::assertSame('VARBINARY(32767)', $this->platform->getBinaryTypeDeclarationSQL(array('length' => 32767)));
        self::assertSame('LONG BINARY', $this->platform->getBinaryTypeDeclarationSQL(array('length' => 32768)));

        self::assertSame('BINARY(1)', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true)));
        self::assertSame('BINARY(1)', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true, 'length' => 0)));
        self::assertSame('BINARY(32767)', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true, 'length' => 32767)));
        self::assertSame('LONG BINARY', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true, 'length' => 32768)));
    }
