...
class DB2PlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesColumnTypesDeclarationSQL()
    {
        ...
        self::assertEquals('VARCHAR(255)', $this->platform->getVarcharTypeDeclarationSQL(array()));
        self::assertEquals('VARCHAR(10)', $this->platform->getVarcharTypeDeclarationSQL(array('length' => 10)));
        self::assertEquals('CHAR(255)', $this->platform->getVarcharTypeDeclarationSQL(array('fixed' => true)));
        ...
        self::assertEquals('INTEGER', $this->platform->getIntegerTypeDeclarationSQL(array()));
        self::assertEquals('INTEGER', $this->platform->getIntegerTypeDeclarationSQL(array(
            'unsigned' => true
        )));
        ...
        self::assertEquals('TIMESTAMP(0) WITH DEFAULT', $this->platform->getDateTimeTypeDeclarationSQL(array('version' => true)));
    ...
    public function testReturnsBinaryTypeDeclarationSQL()
    {
        ...
        self::assertSame('VARBINARY(32704)', $this->platform->getBinaryTypeDeclarationSQL(array('length' => 32704)));
        self::assertSame('BLOB(1M)', $this->platform->getBinaryTypeDeclarationSQL(array('length' => 32705)));
        ...
        self::assertSame('BINARY(32704)', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true, 'length' => 32704)));
        self::assertSame('BLOB(1M)', $this->platform->getBinaryTypeDeclarationSQL(array('fixed' => true, 'length' => 32705)));
    }
