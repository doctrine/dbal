...
class DB2PlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesDDLSnippets()
    {
        ...
        self::assertEquals('TRUNCATE foobar RESTART IDENTITY IMMEDIATE', $this->platform->getTruncateTableSQL('foobar'));
        self::assertEquals('TRUNCATE foobar RESTART IDENTITY IMMEDIATE', $this->platform->getTruncateTableSQL('foobar'), true);
