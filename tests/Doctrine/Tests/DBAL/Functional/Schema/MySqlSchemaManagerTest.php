...
class MySqlSchemaManagerTest extends SchemaManagerFunctionalTestCase
{
    ...
    public function testSwitchPrimaryKeyColumns()
    {
        ...
        $this->sm->createTable($tableOld);
        $tableFetched = $this->sm->listTableDetails("switch_primary_key_columns");
        $tableNew = clone $tableFetched;
        $tableNew->setPrimaryKey(array('bar_id', 'foo_id'));

        $comparator = new Comparator;
        $this->sm->alterTable($comparator->diffTable($tableFetched, $tableNew));

        $table      = $this->sm->listTableDetails('switch_primary_key_columns');
    ...
    public function testDiffTableBug()
    {
        ...
        $tableFetched = $this->sm->listTableDetails("diffbug_routing_translations");
    ...
    public function testFulltextIndex()
    {
        ...
        $indexes = $this->sm->listTableIndexes('fulltext_index');
    ...
    public function testSpatialIndex()
    {
        ...
        $indexes = $this->sm->listTableIndexes('spatial_index');
    ...
    public function testAlterTableAddPrimaryKey()
    {
        ...
        $table = $this->sm->listTableDetails("alter_table_add_pk");
    ...
    public function testDropPrimaryKeyWithAutoincrementColumn()
    {
        ...
        $table = $this->sm->listTableDetails("drop_primary_key");
    ...
    {
        if ($this->sm->getDatabasePlatform() instanceof MariaDb1027Platform) {
        ...
        $onlineTable = $this->sm->listTableDetails("text_blob_default_value");
        ...
        $this->sm->alterTable($comparator->diffTable($table, $onlineTable));
    ...
    public function testListLobTypeColumns()
    {
        ...
        $onlineColumns = $this->sm->listTableColumns($tableName);
    ...
    public function testDiffListGuidTableColumn()
    {
        ...
        $onlineTable = $this->sm->listTableDetails('list_guid_table_column');
    ...
    public function testJsonColumnType() : void
    {
        ...
        $columns = $this->sm->listTableColumns('test_mysql_json');
    ...
    public function testColumnDefaultCurrentTimestamp() : void
    {
        ...
        $onlineTable = $this->sm->listTableDetails("test_column_defaults_current_timestamp");
    ...
    public function testColumnDefaultsAreValid()
    {
        ...
        $currentTimeStampSql = $this->sm->getDatabasePlatform()->getCurrentTimestampSQL();
    ...
    public function testColumnDefaultValuesCurrentTimeAndDate() : void
    {
        ...
        $onlineTable = $this->sm->listTableDetails("test_column_defaults_current_time_and_date");
    ...
    {
        $platform = $this->sm->getDatabasePlatform();
        $this->conn->query('DROP TABLE IF EXISTS test_column_defaults_with_create');
        ...
        $this->conn->query($sql);
        $onlineTable = $this->sm->listTableDetails("test_column_defaults_with_create");
