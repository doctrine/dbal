...
class DBAL421Test extends \Doctrine\Tests\DbalFunctionalTestCase
{
    ...
    {
        $guid = $this->conn->query($this->getSelectGuidSql())->fetchColumn();
    ...
    {
        $statement = $this->conn->prepare($this->getSelectGuidSql());
        $guids = array();
    ...
    {
        return "SELECT " . $this->conn->getDatabasePlatform()->getGuidExpression();
    }
}
