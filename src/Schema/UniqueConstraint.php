...
class UniqueConstraint extends AbstractOptionallyNamedObject
{
    ...
    /**
     * @param string               $name    Name of the unique constraint. If omitted, the name will be generated by the
     *                                      underlying database platform. To facilitate managing the constraint using
     *                                      DBAL, specifying the name explicitly is recommended.
