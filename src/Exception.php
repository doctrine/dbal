...
class Exception extends \Exception
{
    ...
    public static function unknownColumnType(string $name): self
    {
        return new self('Unknown column type "' . $name . '" requested. Any Doctrine type that you use has ' .
            'to be registered with \Doctrine\DBAL\Types\TypeRegistry::register(). You can get a list of all the ' .
            'known types with \Doctrine\DBAL\Types\TypeRegistry::getMap(). If this error occurs during database ' .
