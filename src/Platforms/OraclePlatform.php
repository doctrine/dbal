...
class OraclePlatform extends AbstractPlatform
{
    ...
    {
        return 'NUMBER(10)' . $this->_getCommonIntegerTypeDeclarationSQL($column);
    }
    ...
    {
        return 'NUMBER(20)' . $this->_getCommonIntegerTypeDeclarationSQL($column);
    }
    ...
    {
        return 'NUMBER(5)' . $this->_getCommonIntegerTypeDeclarationSQL($column);
    }
